    ...
    <section id="contact" className="py-24 px-6 md:px-12 lg:px-24 relative z-20">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-gray-100 text-lg mb-10 leading-relaxed max-w-xl mx-auto">
          Right now I&apos;m building Instagent, a multi-agent task-execution system, conducting AI agentic research, and applying ML skills from my Break Through Tech fellowship to real industry problems. I&apos;m actively looking for summer engineering and research roles where systems depth meets applied AI &mdash; my inbox is open.
        </p>
